...
const serverHost = process.env.SERVER_HOST || 'Shadow_xD67.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '30662', 10);
const botUsername = process.env.BOT_USERNAME || '247-BOT';
